...
const Queue = require('../data-structure/4. queue')

const printPrince = (n, k) => {
	const princeQueue = new Queue()

	for (let i = 1; i <= n; ++i) {
		princeQueue.enqueue(i)
	}
	...
	while (true) {
		...
		for (let i = 0; i < k - 1; ++i) {
			princeQueue.enqueue(princeQueue.dequeue().element)
		}
		princeQueue.dequeue()
	}

	return princeQueue.dequeue().element
}

console.log(printPrince(8, 3))
