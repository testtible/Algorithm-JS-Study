...
const printMaximumStudents = (n, m, infos) => {
	const prices = infos.map((info) => info[0] + info[1]).sort((a, b) => a - b)
	let budget = m
	let count = 0
...
console.log(printMaximumStudents(5, 28, [ [ 6, 6 ], [ 2, 2 ], [ 4, 3 ], [ 4, 5 ], [ 10, 3 ] ]))
