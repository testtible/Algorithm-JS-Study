...
const findIllegalCars = (unitsOfDate, ...carNumbers) => {
	return carNumbers.filter((carNumber) => carNumber % 10 === unitsOfDate).length
}

console.log(findIllegalCars(3, 25, 23, 11, 47, 53, 17, 33))
console.log(findIllegalCars(0, 12, 20, 54, 30, 87, 91, 30))
